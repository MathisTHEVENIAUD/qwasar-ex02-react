...
export const properties: Property[] = [
  ...
  {
    id: "4",
    title: "Dormez dans un véritable avion",
    description:
      "Décollage immédiat pour un séjour insolite ! L'avion du Haut Village, peut accueillir 4 personnes, il est tout équipé (kitchenette, WC, douche...), composé d'une chambre avec un grand lit, 2 lits enfant dans le séjour. De plus, vous pourrez profiter de la piscine (mai à mi septembre) et des toboggans aquatiques sur place. Situé à Saint Michel Chef Chef, en Loire Atlantique, vous serez à 2 minutes des plages de Tharon, Pornic et Saint-Brévin.",
    image: "/img/airbnb_04.png",
    images: ["/img/airbnb_04.png", "/img/airbnb_01.png", "/img/airbnb_02.png"],
    price: 123,
    rating: 4.72,
    reviewCount: 46,
